...
module.exports = (app, keycloak) => {
  ...
  app.all(['/announcement', '/announcement/*', '/search', '/search/*',
    ...
    '/resources/*', '/myActivity', '/myActivity/*', '/org/*', '/manage', '/:slug/contribute', '/:slug/contribute/*', '/contribute','/contribute/*', '/create', '/create/*', '/edit', '/edit/*'], keycloak.protect(), indexPage(true))
